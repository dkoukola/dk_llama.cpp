...
struct llama_model {
    ...
    struct ggml_tensor * dflash_markov_w1 = nullptr;
    struct ggml_tensor * dflash_markov_w2 = nullptr;
    struct ggml_tensor * dflash_conf_proj = nullptr;
    struct ggml_tensor * dflash_conf_proj_b = nullptr;
    ...
    const ggml_tensor * dflash_io_target_output_mtp = nullptr;
