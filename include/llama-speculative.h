...
struct llama_speculative_engine_params {
    /* Target and auxiliary models must remain alive until engine destruction. An auxiliary
     * whose missing IO tensors are borrowed or cloned from the target becomes bound to that
     * target; keep the target alive until the auxiliary is freed, and reload the auxiliary
     * model instead of rebinding it to another target. */
